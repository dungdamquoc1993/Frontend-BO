              ...
              <div class="vx-row m-0 mb-3">
                ...
                <div class="w-1/2 mb-2">
                  <label class="sample cursor-pointer"
                    ...
                    <input type="file" ref="imgFront" @change="successUploadFront($event.target.files)" class="hidden"
              ...
              <div class="vx-row m-0 mb-3">
                ...
                <div class="w-1/2 mb-2">
                  <label class="sample cursor-pointer"
                    ...
                    <span class="iconUpload"></span>
                    <input type="file" ref="imgBack" @change="successUploadBack($event.target.files)" class="hidden"
                      accept="image/png, image/jpg, image/jpeg">
                  </label>
                </div>
                <div class="w-1/2 mb-2">
...
<style>.con-upload .con-input-upload,
